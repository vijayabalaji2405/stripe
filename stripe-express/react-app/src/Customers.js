...
export function SignIn() {
  const signIn = async () => {
    const credential = await auth.signInWithPopup(
      //auth.signInWithPopup it will create a popup sign in methods with google account
...
function SaveCard(props) {
  ...
  //AuthCheck will only render his children when the user is logged in or fallback to sign in
