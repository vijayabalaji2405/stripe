      ...
      <AuthCheck fallback={<SignIn />}>
        ...
        <div className="well">
          ...
          <button
            className={
              "btn " +
              (plan === "price_1KZ79jSAEfEC9jrMQdmQj84p"
                ? "btn-primary"
                : "btn-outline-primary")
            }
            onClick={() => setPlan("price_1KZ79jSAEfEC9jrMQdmQj84p")}
          >
            Choose Monthly 100 INR/m
          </button>

          <button
            className={
              "btn " +
              (plan === "price_1KZ7DNSAEfEC9jrMSE5l2VvJ"
                ? "btn-primary"
                : "btn-outline-primary")
            }
            onClick={() => setPlan("price_1KZ7DNSAEfEC9jrMSE5l2VvJ")}
          >
